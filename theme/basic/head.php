    ...
    <div>
        <ul class="board_nav">
            <?php if($board_user == 1){ ?>
                ...
                <li class="board_nav_list <?= $board_notice_border ?>"><a href="../bbs/board.notice.php?bo_table=notice&bo_idx=1&bo_titile=1" >자료실</a></li>
            <?php } ?>
            
            
             <?php if($board_user == 2) { ?>
                <li class="board_nav_list <?= $board_rater_border ?>"><a href="../bbs/board.rater.php?bo_table=qa&bo_idx=1">심사관리</a></li>
                <li class="board_nav_list <?= $board_notice_border ?>"><a href="../bbs/board.notice.php?bo_table=notice&bo_idx=1&bo_titile=2" >공지사항</a></li>
            <?php } ?>
