...
// 여기 입니다.
if ($is_search_bbs) {
    $sql = " select  * from {$write_table} where {$sql_search} and wr_title_idx = '{$_GET['bo_idx']}' {$sql_order} DESC limit {$from_record}, $page_rows ";
    // echo $sql;
} else {
...
include_once($board_skin_path.'/list.app.skin.php');
?>
