            ...
            <table class="view_table_app">
                ...
                <tbody id="input_file_cont">
                    ...
                    <tr>
                        ...
                        <td scope="col" class="view_table_text " colspan="7" style="">
        ...
        <input type="hidden" id="date_value"  name="date_value" value="<?php echo $row22['value'] ?>">
            ...
            <table class="view_table_app">
                ...
                <tbody id="input_file_cont">
                    ...
                    <tr class="view_table_header_table"></tr>
                    <tr>
                        <th scope="col" class="view_table_header" rowspan="11" colspan="2" style="">소속기관</th>
                        ...
                        <th scope="col" class="view_table_header" colspan="2" style="">소속</th>
                    </tr>
