...
<a href="<?php echo G5_URL ?>"><img src="<?php echo G5_IMG_URL ?>/logo.png" alt="<?php echo $config['cf_title']; ?>"></a>
    <div class="mbskin_box">
        ...
        <div class="mb_log_cate">
            <h2><span class="sound_only">로그인 정보</span></h2>
            <a href="<?php echo G5_BBS_URL ?>/register.php" class="join">회원가입</a>
            <a href="<?php echo G5_BBS_URL ?>/register.php" class="join">아이디 찾기</a>
            <a href="<?php echo G5_BBS_URL ?>/register.php" class="join">비밀번호 찾기</a>
        </div> -->
        ...
        <fieldset id="login_fs">
            ...
            <div id="login_info">
                ...
                <div class="login_if_lpl">
                    게정이 없으신가요? 
                    <strong>
                        <a href="<?php echo G5_BBS_URL ?>/register_form.php">회원가입</a>
                    </strong>
                </div>
            </div>
        </fieldset> 
