...
if (isset($wr_bo_idx) && $wr_bo_idx) {
   
    $sql1 = " SELECT * FROM `g5_write_business` where wr_id = '{$wr_bo_idx} ";
    $result1 = sql_query($sql1);
    
        
    include_once(G5_BBS_PATH.'/view.report.php');
} else {
    include_once (G5_BBS_PATH.'/list.report.php');
