...
if ($sca || $stx || $stx === '0') {     //검색이면
    ...
    */
    ...
    if($_GET['bo_idx'] == 1){
        ...
        $sql = " select COUNT(DISTINCT `idx`) as cnt from g5_business_propos where bo_idx = '{$_GET['wr_idx']}' and report_val_2 = 4";
        $row = sql_fetch($sql);
    }
...
// 여기 입니다.
    ...
    if($_GET['bo_idx'] == 1){
        ...
        $sql = " select * from g5_business_propos where bo_idx = '{$_GET['wr_idx']}' and report_val_2 = 4";
    }
...
include_once($board_skin_path.'/view.rater.quest.list.skin.php');
?>
