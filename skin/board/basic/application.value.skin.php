...
<?php if ($row['bo_title_idx'] == 1) {  ?>
    <section id="bo_v" style="width:80%;">
        ...
        <input type="hidden" id="date_value"  name="date_value" value="<?php echo $row22['value'] ?>">
            ...
            <a href="<?= G5_BBS_URL ?>/board.value.php?bo_table=business&bo_idx=<?= $_GET['bo_idx'] ?>&us_idx=<?= $_GET['us_idx'] ?>&update=1" class=" btn_next_prv btn_next_prv_link date_value">수정</a>
                <a href="<?= G5_BBS_URL ?>/board.value.php?bo_table=business&bo_idx=<?= $_GET['bo_idx'] ?>" class=" btn_next_prv btn_next_prv_link">확인</a>
            </div>
        </form>
    </section>
    <script>
